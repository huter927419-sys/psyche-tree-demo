...
const ui = {
  zh: {
    ...
    guideCoverTagline: '先读同观，合观六卷',
    guideCoverShelfTagline: '先读同观',
    guideCoverOpen: '展卷同观',
    guideCoverOpenHint: '几则人生片羽，一页一页翻过——此卷不留痕，只为照见六卷所为何。',
    guideCoverHint: '不求分数，不生成神谕；读罢再择六卷而入。',
    guideFirstVisitHint: '若不悉六卷照什么，可先展读此卷',
    guideBackToShelf: '返回书架',
    guideChapterLabel: '同观',
    ...
    coverOpen: '展开记忆',
    coverReview: '回顾此卷',
    coverReviewHint: '此卷已照见——溯息、展息细读先前择定的光印与评述，不可改选。',
    closeCaption: '合卷归岸…',
    languageLabel: '阅读语言',
    ...
    reviewModeHint: '此卷已照见，光印不可改选——可溯息、展息细读。',
  ...
  en: {
    ...
    guideCoverTagline: 'Shared view first—then choose a volume',
    guideCoverShelfTagline: 'Mirror shared view',
    guideCoverOpen: 'Unfold shared view',
    guideCoverOpenHint:
      'Vignettes, one spread at a time—no trace kept, only why the six volumes mirror.',
    ...
    coverReviewHint:
      'This volume is already mirrored—turn back or forward to read your chosen marks; they cannot be changed.',
    ...
    selectOneHint: 'Choose one—the spread breathes forward',
    prevPage: 'Turn back',
    nextPage: 'Turn forward',
    ...
    reviewModeHint:
      'This volume is sealed—your marks cannot change. Turn back or forward to read.',
    attentionHint:
    ...
    volumeRiteNext: 'Next',
    volumeRiteBegin: 'After the breath-interval, enter seals',
    volumeRiteSeeResult: 'Enter the mirror',
    volumeRiteExitLabel: 'Closing rite',
    volumeRiteEntryAria: 'Volume entry rite · breath-interval',
    volumeRiteExitAria: 'Volume closing rite',
    volumeRiteJournalOptional: 'Optional: one sentence, for yourself only',
    volumeRiteBreathIntervalHint: 'In the breath-interval—no hurry; next when ready',
  ...
  ja: {
    ...
    guideCoverTagline: '先に同観——そのあと六巻へ',
    guideCoverShelfTagline: '同観を映す',
    guideCoverOpen: '同観を展ず',
    guideCoverOpenHint:
      '人生の片羽を、一頁ずつめくる——此巻は痕を残さず、六巻が何を映すかを照すため。',
    ...
    coverReviewHint:
      'この巻はすでに照見済——前息へ、次息へで選んだ光印と评述をお読みください。改選はできません。',
    closeCaption: '巻を閉じ、岸へ…',
    languageLabel: '読む言語',
    memorySpread: (n: number, total: number) => `この巻六印 · ${n}/${total}`,
    facetOfWhole: '六向の一つ',
    dialogueCheck: '対話確認',
    selectOneHint: '一つ選べ、息自ら展ず',
    prevPage: '前息へ',
    nextPage: '次息へ',
    closeBook: '巻を閉じ岸へ',
    backToShelf: '書架へ戻る',
    ...
    reviewModeHint: 'この巻は照見済——光印は改選できません。前息へ、次息へでお読みください。',
    attentionHint:
...
export type UiStrings = {
  ...
  volumeRiteBreathIntervalHint: string
