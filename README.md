...
四层文档均为**中英日三语**，自「如何进入体验」递进到「通用动力学」。
...
|-----------|------|---------|--------|
| **README.md** | 本文件：产品说明、界面预览、四层理论、安装运维 | This file: product, UI preview, four theory layers, setup | 本ファイル：製品・画面・四層理論・セットアップ |
...
**理论栈速查** I [玄学](#玄学理论体系--mystical-framework--玄義体系) → II [简明](#psyche-tree--六维书--简明理论--concise-theory--簡明理論) → III [泛化](#psyche-tree-system--进阶泛化层--advanced-generalization--進階汎化層) → IV [增强](#psyche-tree-system--增强理论版--enhanced-theory--拡張理論)
