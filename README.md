...
序文回答：为何还需要另一套体系 · 雾岸不是新信仰 · 东方／心理学／世界观研究如何 **交映** · 为何不用分数与类型 · 为何是六卷 · 希望留下什么 · 写给未来的读者。
...
| 章 | 在说什么 |
|----|----------|
| 一 | 与 MBTI、咨询、正念、世界观研究等 **各答不同之问**，为何不互相取代 |
| 二 | **不是新信仰**——观察自己、观察接缘、观察变化 |
| 三 | **交映**：周易／庄子／大学 … 与 meaning making、worldview、phenomenology 并置同席 |
| 四 | 为何 **无分数无类型**；留痕、归树、整象来自世界观而非考试逻辑 |
| 五 | 六卷是 **六种观察法**，不是六种人格 |
| 六 | 若愿停下看自己的回应，读卷已有意义 |
| 七 | 未来可变；愿留「变化里仍愿照见」 |
...
**雾岸**不是「答完 → 打分 → 给型」的测评，而是**先校准如何看见，再留此息之象**（详见 [序文 · 第四章](docs/为什么会有雾岸六卷.md#第四章--为什么不用传统心理测试的方法)）：
...
│   ├── references/                    # 外部文献 PDF（如 Taves 2018）
│   ├── theory/
