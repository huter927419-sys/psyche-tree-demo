...
| **🌿 理解雾岸的基础** | [**《关系论·总纲》**](docs/关系论·总纲.md) — 非理论栈、非实践篇；六卷之前先立「关系之道」 |
| 副标题 | 古今互照 · 同观生命 |
| 形式 | 开篇 + 六题同观 + 论文同观 + 六卷留痕 + 收束（**简体 · English · 日本語** · 非论文） |
| 现行发布 | GitHub `docs/`（**官网版待上线**，内容与序文同源） |

序文回答：同观而非谁正确 · 变／照／流／应／连／向 **古今互照** · **Taves (2018) 论文同观** · 六卷与留痕 · 写给未来的读者。
...
| | |
|---|---|
| [**先读 · 为什么会有〈雾岸六卷〉**](docs/为什么会有雾岸六卷.md) | 同观 · 古今互照 · 非教门非测评 |
| [**理解雾岸的基础 · 《关系论·总纲》**](docs/关系论·总纲.md) | 万物因关系而在 · 非理论栈 · 非实践篇 |
...
序文 **不讨论谁正确**，只并置 **看的是同一件事** 的不同说法（不作学术论文）：

| 章 | 在说什么 |
|----|----------|
| 开篇 | 雾岸所问 · 非教门 · **可相照，不作证明** |
| 一–六 | **变 · 照 · 流 · 应 · 连 · 向** — 每章 **古今互照**（含 Taves 等可相照之处） |
| 七 | **[论文同观 · Taves (2018)](docs/theory/cross/Taves2018-雾岸交叉读.md)** — BQs 表 · enacted/articulated · 并读偈 |
| 八 | 六卷意象 · 留痕无分数无类型 |
| 九 | 写给未来的读者 |
| 收束 | **[诸家互照总表](docs/为什么会有雾岸六卷.md#收束--诸家互照)** — 六题并列；不互证、不取代 |
...
本篇 **不是** [理论栈](#三理论栈) 的一章，**不是** [实践篇](docs/theory/implement/README.md) 的一章——而是 **理解雾岸的基础**：在读序文、理论或体验六卷之前，先立「万物因关系而在」。

> 天地之间，未有一物独立而生。万物皆因缘而起，因相互而成。

[《关系论·总纲》](docs/关系论·总纲.md) 以 **古文 · 白话** 十节立此根基。读罢可知：**六卷** 是普通人学习 **「关系之道」** 的六种观察方法——**观心、观缘、观行**，不是算命，也不是人格分类。
...
再往下，才是 [序文 · 同观](docs/为什么会有雾岸六卷.md)、[世界观 01–06](docs/theory/README.md) 与 [实践篇 01–08](docs/theory/implement/README.md)。  
（实践篇 [04 关系论](docs/theory/implement/04-关系论.md) 讲 **体验如何践行连接**；总纲讲 **为何以关系为根**——同名不同层。）

---

## 一、这是什么

**雾岸**采用「先校准如何看见，再留此息之象」的体验路径（详见 [序文 · 八 · 六卷与留痕](docs/为什么会有雾岸六卷.md#八--六卷与留痕)）：
...
| 读什么 | 去哪 |
|--------|------|
| **理解雾岸的基础（关系之根）** | [**《关系论·总纲》**](docs/关系论·总纲.md) — 非理论栈、非实践篇 |
...
> **读理论栈之前**，可先读 **[《关系论·总纲》](docs/关系论·总纲.md)** —— 理解雾岸的基础，**不在**下列两层之内。
