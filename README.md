...
|-----------|------|---------|--------|
| **SKILL.md** | Agent 工作流：六卷结构、加书、整象规则 | Agent workflow: six books, add volume, holistic rules | Agent ワークフロー：六巻・追加・整象規則 |
| **reference.md** | 路径索引、数据流、验证脚本 | File index, data flow, test scripts | パス索引、データフロー、検証脚本 |
| **README.md** | 本文件：体验、**玄学理论体系**、**简明状态理论**、安装、运维 | This file: experience, **mystical framework**, **concise state theory**, setup, ops | 本ファイル：体験・**玄義体系**・**簡明理論**・セットアップ・運用 |
